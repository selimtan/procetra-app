(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("realmocean$core"), require("tuval$core"));
	else if(typeof define === 'function' && define.amd)
		define(["realmocean$core", "tuval$core"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("realmocean$core"), require("tuval$core")) : factory(root["realmocean$core"], root["tuval$core"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(self, function(__WEBPACK_EXTERNAL_MODULE__realmocean_core__, __WEBPACK_EXTERNAL_MODULE__tuval_core__) {
...
/* harmony import */ var _query__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./query */ "./src/query.ts");
...
var JsonAdaptor = /** @class */ (function (_super) {
    ...
    JsonAdaptor.prototype.lazyLoadGroup = function (args) {
        ...
        if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(args.lazyLoad.onDemandGroupInfo)) {
    ...
    JsonAdaptor.prototype.insert = function (dm, data, tableName, query, position) {
        if ((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(position)) {
    ...
    JsonAdaptor.prototype.update = function (dm, keyField, value, tableName) {
        ...
        var i;
        var key;
        if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(keyField)) {
            key = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.getValue)(keyField, value);
        }
        for (i = 0; i < ds.length; i++) {
            if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(keyField) && ((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.getValue)(keyField, ds[i])) === key) {
                break;
            }
        }
        return i < ds.length ? (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.merge)(ds[i], value) : null;
    };
    return JsonAdaptor;
}(Adaptor));
...
var UrlAdaptor = /** @class */ (function (_super) {
    ...
    UrlAdaptor.prototype.processQuery = function (dm, query, hierarchyFilters) {
        ...
        for (var i = 0; i < queries.filters.length; i++) {
            ...
            if ((this.getModuleName &&
                ...
                !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(queries.filters[i].e.key) && queries.filters.length > 1) {
                res = "(" + res + ")";
            }
    ...
    UrlAdaptor.prototype.processResponse = function (data, ds, query, xhr, request, changes) {
        ...
        if (Array.isArray(data.result) && data.result.length) {
            ...
            var val = 'value';
            var level = 'level';
            if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(data.result[0][key])) {
    ...
    UrlAdaptor.prototype.formRemoteGroupedData = function (data, level, childLevel) {
        ...
        data[records] = data[0].items.length ? this.getGroupedRecords(data, !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(data[0].items[records])) : [];
        return data;
    };
    ...
    UrlAdaptor.prototype.batchRequest = function (dm, changes, e, query, original) {
        ...
        return {
            ...
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            data: JSON.stringify((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.extend)({}, {
    ...
    UrlAdaptor.prototype.getAggregateResult = function (pvt, data, args, groupDs, query) {
        ...
        var key = 'key';
        var isServerGrouping = Array.isArray(data.result) && data.result.length && !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(data.result[0][key]);
        if (pvt && pvt.groups && pvt.groups.length && !isServerGrouping) {
            var groups = pvt.groups;
            for (var i = 0; i < groups.length; i++) {
                var level = null;
                if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(groupDs)) {
...
var ODataAdaptor = /** @class */ (function (_super) {
    ...
    function ODataAdaptor(props) {
        ...
        _this.options = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.extend)({}, _this.options, {
            requestType: 'get',
        ...
        (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.extend)(_this.options, props || {});
        return _this;
    }
    ...
    ODataAdaptor.prototype.onPredicate = function (predicate, query, requiresCast) {
        ...
        if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(this.getModuleName) && this.getModuleName() === 'ODataV4Adaptor') {
    ...
    ODataAdaptor.prototype.processResponse = function (data, ds, query, xhr, request, changes) {
        ...
        var pvtData = 'pvtData';
        if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(data.d)) {
            var dataCopy = ((query && query.isCountRequired) ? data.d.results : data.d);
            var metaData = '__metadata';
            if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(dataCopy)) {
                for (var i = 0; i < dataCopy.length; i++) {
                    if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(dataCopy[i][metaData])) {
    ...
    ODataAdaptor.prototype.localTimeReplacer = function (key, convertObj) {
        for (var _i = 0, _a = !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(convertObj) ? Object.keys(convertObj) : []; _i < _a.length; _i++) {
            var prop = _a[_i];
    ...
    ODataAdaptor.prototype.update = function (dm, keyField, value, tableName, query, original) {
        if (this.options.updateType === 'PATCH' && !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(original)) {
    ...
    ODataAdaptor.prototype.generateBodyContent = function (arr, e, stat, dm) {
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(arr[i]['@odata.etag'])) {
        ...
        if (request && this.options.batch && _util__WEBPACK_IMPORTED_MODULE_1__.DataUtil.endsWith(request.url, this.options.batch) && request.type.toLowerCase() === 'post') {
            ...
            for (var i = d.length; i > -1; i--) {
                ...
                if (changes.addedRecords[cIdx]) {
                    ...
                    (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.extend)({}, changes.addedRecords[cIdx], this.processResponse(jsonObj));
                }
            }
            return changes;
        }
    ...
    ODataAdaptor.prototype.compareAndRemove = function (data, original, key) {
        var _this = this;
        if ((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(original)) {
            return data;
        }
...
var ODataV4Adaptor = /** @class */ (function (_super) {
    ...
    ODataV4Adaptor.prototype.processResponse = function (data, ds, query, xhr, request, changes) {
        ...
        data = !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(data.value) ? data.value : data;
        var args = {};
        args.count = count;
        args.result = data;
        this.getAggregateResult(pvt, data, args, null, query);
...
var RemoteSaveAdaptor = /** @class */ (function (_super) {
    ...
    function RemoteSaveAdaptor() {
        var _this = _super.call(this) || this;
        (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.setValue)('beforeSend', UrlAdaptor.prototype.beforeSend, _this);
        return _this;
    }
...
var GraphQLAdaptor = /** @class */ (function (_super) {
    ...
    GraphQLAdaptor.prototype.processResponse = function (resData, ds, query, xhr, request) {
        ...
        var count;
        var aggregates;
        var result = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.getValue)(this.schema.result, res.data);
        if (this.schema.count) {
            count = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.getValue)(this.schema.count, res.data);
        }
        if (this.schema.aggregates) {
            aggregates = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.getValue)(this.schema.aggregates, res.data);
            aggregates = !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(aggregates) ? _util__WEBPACK_IMPORTED_MODULE_1__.DataUtil.parse.parseJson(aggregates) : aggregates;
        }
        ...
        return !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(count) ? { result: args.result, count: count, aggregates: aggregates } : args.result;
    };
    /**
     * Prepare and returns request body which is used to insert a new record in the table.
     */
...
var CacheAdaptor = /** @class */ (function (_super) {
    ...
    function CacheAdaptor(adaptor, timeStamp, pageSize) {
        ...
        if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(adaptor)) {
        ...
        if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(timeStamp)) {
    ...
    CacheAdaptor.prototype.beforeSend = function (dm, request, settings) {
        if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(this.cacheAdaptor.options.batch) && _util__WEBPACK_IMPORTED_MODULE_1__.DataUtil.endsWith(settings.url, this.cacheAdaptor.options.batch)
...
//globalObject = global;
/// #endif
globalObject['realmocean$data'] = _index__WEBPACK_IMPORTED_MODULE_1__;
_tuval_core__WEBPACK_IMPORTED_MODULE_0__.ModuleLoader.FireModuleLoadedEvent('realmocean$data', _index__WEBPACK_IMPORTED_MODULE_1__);
if (_tuval_core__WEBPACK_IMPORTED_MODULE_0__.is.workerContext()) {
    console.log('tuval data yüklendi.');
...
/* harmony export */ });
/* harmony import */ var _manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./manager */ "./src/manager.ts");
/* harmony import */ var _query__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./query */ "./src/query.ts");
/* harmony import */ var _adaptors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./adaptors */ "./src/adaptors.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./util */ "./src/util.ts");
/* harmony import */ var _exports__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./exports */ "./src/exports.ts");
/**
 * Data modules
 */
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util */ "./src/util.ts");
/* harmony import */ var _query__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./query */ "./src/query.ts");
/* harmony import */ var _adaptors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./adaptors */ "./src/adaptors.ts");
...
var DataManager = /** @class */ (function () {
    ...
    function DataManager(dataSource, query, adaptor) {
        ...
        if (data.requiresFormat === undefined && !_util__WEBPACK_IMPORTED_MODULE_1__.DataUtil.isCors()) {
            data.requiresFormat = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(data.crossDomain) ? true : data.crossDomain;
        }
        ...
        if (query.subQuery) {
            ...
            for (var j = 0; j < res.length; j++) {
                if (res[j][from] instanceof Array) {
                    res[j] = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.extend)({}, {}, res[j]);
    ...
    DataManager.prototype.executeQuery = function (query, done, fail, always) {
        ...
        if (!this.dataSource.offline && (this.dataSource.url !== undefined && this.dataSource.url !== '')
            || (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(this.adaptor[makeRequest])) || this.isCustomDataAdaptor(this.adaptor)) {
            var result = this.adaptor.processQuery(this, query);
            if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(this.adaptor[makeRequest])) {
                this.adaptor[makeRequest](result, deffered, args, query);
            }
            else if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(result.url) || this.isCustomDataAdaptor(this.adaptor)) {
    ...
    DataManager.prototype.extendRequest = function (url, fnSuccess, fnFail) {
        return (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.extend)({}, {
            type: 'GET',
    ...
    DataManager.prototype.makeRequest = function (url, deffered, args, query) {
        ...
        var fnSuccess = function (data, request) {
            if (_this.isGraphQLAdaptor(_this.adaptor)) {
                if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(data['errors'])) {
                    return fnFail(data['errors'], request);
                }
            }
            if (_this.isCustomDataAdaptor(_this.adaptor)) {
                request = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.extend)({}, _this.ajaxReqOption, request);
            }
        ...
        if (!this.isCustomDataAdaptor(this.adaptor)) {
            var ajax_1 = new _realmocean_core__WEBPACK_IMPORTED_MODULE_0__.Ajax(req);
    ...
    DataManager.prototype.saveChanges = function (changes, key, tableName, query, original) {
        ...
        if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(this.adaptor[doAjaxRequest])) {
            return this.adaptor[doAjaxRequest](req);
        }
        else if (!this.isCustomDataAdaptor(this.adaptor)) {
            var deff_1 = new Deferred();
            var ajax_2 = new _realmocean_core__WEBPACK_IMPORTED_MODULE_0__.Ajax(req);
    ...
    DataManager.prototype.successFunc = function (record, request) {
        ...
        if (this.isCustomDataAdaptor(this.adaptor)) {
            request = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.extend)({}, this.ajaxReqOption, request);
        }
        try {
        ...
        record = this.adaptor.processResponse(_util__WEBPACK_IMPORTED_MODULE_1__.DataUtil.parse.parseJson(record), this, null, request.httpRequest, request);
    ...
    DataManager.prototype.doAjaxRequest = function (res, ajaxFunc) {
        var _this = this;
        res = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.extend)({}, {
            type: 'POST',
            contentType: 'application/json; charset=utf-8',
            processData: false
        }, res);
        ...
        if (!this.isCustomDataAdaptor(this.adaptor)) {
            var ajax_3 = new _realmocean_core__WEBPACK_IMPORTED_MODULE_0__.Ajax(res);
...
/* harmony import */ var _realmocean_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @realmocean/core */ "@realmocean/core");
/* harmony import */ var _realmocean_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_realmocean_core__WEBPACK_IMPORTED_MODULE_1__);
...
var Query = /** @class */ (function () {
    ...
    Query.prototype.sortByForeignKey = function (fieldName, comparer, isFromGroup, direction) {
        var order = !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_1__.isNullOrUndefined)(direction) ? direction : 'ascending';
        var sorts;
        var temp;
...
/* harmony import */ var _realmocean_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @realmocean/core */ "@realmocean/core");
/* harmony import */ var _realmocean_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_realmocean_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./manager */ "./src/manager.ts");
/* harmony import */ var _query__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./query */ "./src/query.ts");
...
var DataUtil = /** @class */ (function () {
    ...
    DataUtil.fnAscending = function (x, y) {
        if ((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(x) && (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(y)) {
            return -1;
        }
    ...
    DataUtil.group = function (jsonArray, field, aggregates, level, groupDs, format, isLazyLoad) {
        ...
        var _loop_2 = function (i) {
            ...
            if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(format)) {
            ...
            grouped[val].count = !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(groupDs) ? grouped[val].count : grouped[val].count += 1;
    ...
    DataUtil.setValue = function (nameSpace, value, obj) {
        ...
        for (i = 0; i < length; i++) {
            ...
            else if ((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(fromObj[key])) {
                fromObj[key] = {};
            }
            fromObj = fromObj[key];
        }
    ...
    DataUtil.callAdaptorFunction = function (adaptor, fnName, param1, param2) {
        if (fnName in adaptor) {
            ...
            if (!(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(res)) {
                param1 = res;
            }
        }
        return param1;
    ...
    DataUtil.getItemFromComparer = function (array, field, comparer) {
        ...
        if (array.length) {
            while ((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(keyVal) && i < array.length) {
        ...
        for (; i < array.length; i++) {
            ...
            if ((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(current)) {
                continue;
            }
            if (castRequired) {
                keyVal = +keyVal;
    ...
    DataUtil.distinct = function (json, fieldName, requiresCompleteRecord) {
        requiresCompleteRecord = (0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(requiresCompleteRecord) ? false : requiresCompleteRecord;
        var result = [];
        var val;
        var tmp = {};
    ...
    DataUtil.prepareQuery = function (dm) {
        ...
        if (dm.where) {
            ...
            where.filter(function (pred) {
                if ((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(pred.condition)) {
    ...
    DataUtil.fnOperators = {
        ...
        lessthan: function (actual, expected, ignoreCase) {
            ...
            if ((0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(actual)) {
                actual = undefined;
            }
            return actual < expected;
        },
        ...
        contains: function (actual, expected, ignoreCase, ignoreAccent) {
            ...
            if (ignoreCase) {
                return !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(actual) && !(0,_realmocean_core__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(expected) &&
