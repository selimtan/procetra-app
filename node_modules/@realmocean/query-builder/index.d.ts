...
import { RadioButtonModel } from '@realmocean/buttons';
import { DropDownTreeModel } from '@realmocean/dropdowns';
import { MultiSelectModel, DropDownListModel } from '@realmocean/dropdowns';
import { EmitType, BaseEventArgs } from '@realmocean/core';
import { Query, Predicate, DataManager } from '@realmocean/data';
import { TextBoxModel, NumericTextBoxModel } from '@realmocean/inputs';
import { DatePickerModel } from '@realmocean/calendars';
...
export class QueryBuilderEx extends Control<QueryBuilderEx> {
    get DataSource(): any;
    set DataSource(value: any);
    get Columns(): ColumnsModel[];
    set Columns(value: ColumnsModel[]);
    get Rule(): RuleModel;
    set Rule(value: RuleModel);
